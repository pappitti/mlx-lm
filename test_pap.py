...
checkpoint = "mlx-community/Mistral-Small-3.2-24B-Instruct-2506-q8"

tokenizer_config = {
    "chat_template": CHAT_TEMPLATE.get(checkpoint, None),
}

# Load the corresponding model and tokenizer
model, tokenizer = load(path_or_hf_repo=checkpoint, tokenizer_config=tokenizer_config)
